...
class Activetokens extends StatefulWidget {
  @override _ActivetokensViewState createState() => _ActivetokensViewState();
}

class _ActivetokensViewState extends State<Activetokens> {
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            MaterialButton(
              onPressed: () {
                Navigator.of(context).pushNamed(AppRoutes.authOpening);
              },
              child: Text(
                "BACK",
                style: Theme
